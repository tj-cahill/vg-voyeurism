...
## Normality
We should also check the assumptions of normality for some of the variables of interest. For this, we use the Shapiro-Wilk testto test the hypothesis of normality on each variable. (*Note: This may be subject to issues related to multiple testing. If we want to be very conservative, we could apply a Bonferroni correction.*)
