...
# on average either watching or playing games)
...
```
Visualization suggests that most respondents don't play games, but do watch some, and that there are a small number of extreme outliers in terms of both playing and watching (i.e., the figures are right-skewed).

The ANCOVA model suggests that while there are still not significant differences in perceived player efficacy as a result of the streamer's gender, there is **significant covariance** between experience watching streamed video game content and the perceived efficacy of the streamer.
